...
wget -q "https://people.sc.fsu.edu/~jburkardt/data/vtk/rbc_001.vtk" -O rbc.vtk
wget -q "https://www.ece.lsu.edu/xinli/Meshing/Data/bunny.vtk" -O bunny.vtk
python eval_mesh.py bunny.vtk -o colored.vtk -f "y = x[:,1]"
python read_mesh.py colored.vtk -n 2
python read_mesh.py rbc.vtk -n 2
